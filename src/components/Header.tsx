...
export default function Header({
  ...
  return (
    <section id="header" className="w-full h-screen bgCustomized relative overflow-hidden">
      <div className="heroGlow heroGlowLeft" />
      <div className="heroGlow heroGlowRight" />
      <div className="content h-full flex flex-col justify-center items-start px-2 relative z-10">
        <div className="w-full flex justify-between">
          <div className="w-full flex md:block flex-col justify-center items-center md:w-1/2 lg:w-2/3">
            <h1 className="text-white font-extrabold text-center md:text-left text-5xl md:text-6xl xl:text-8xl max-w-3xl drop-shadow-lg">
              {title}
            </h1>
            ...
            <div className="mt-20 flex gap-16 p-5 rounded-2xl infoCard">
